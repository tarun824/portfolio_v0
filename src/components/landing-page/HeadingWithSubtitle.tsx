...
function HeadingWithSubtitle({
  ...
  return (
    ...
    >
      <p className="text-4xl font-extrabold font-inter-sans text-[#FFFFFF]">
        {heading}
      </p>
      <p className="text-sm font-semibold font-inter-sans bg-gradient-to-r from-[#4FC3F7] to-[#F5F5F5] bg-clip-text text-transparent">
        {/* Get to know me{" "} */}
        {subTitle}
      </p>
    </div>
